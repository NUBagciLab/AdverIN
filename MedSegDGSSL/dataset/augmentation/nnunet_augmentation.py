...
from MedSegDGSSL.dataset.augmentation.custom_transforms import MinMaxNormalization, MinMaxNormalization
...
def nnunet_augmentation(patch_size, params_key='3D'):
    if params_key =='3D':
