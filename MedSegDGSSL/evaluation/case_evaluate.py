...
from MedSegDGSSL.evaluation.metrics import ConfusionMatrix, ALL_METRICS
...
def evaluate_single_case(predict_np, label_np, case_name, 
    ...
    try:
        ...
        for label, name in labels.items():
            ...
            confusion_matrix.set_test(predict_np==int(label))
            confusion_matrix.set_reference(label_np==int(label))
        ...
        print("Error evaluation: ", case_name)
