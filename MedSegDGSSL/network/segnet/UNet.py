"""
The Encoder structure for Encoder-decoder style network
the output should be the encoded feature list
"""
...
class BasicUNet(nn.Module):
    ...
    def __init__(
        ...
        self.is_return_feature = is_return_feature
    ...
    def forward(self, x: torch.Tensor):
        ...
        if self.training and self.is_return_feature:
